...
file copy -force [glob $projName.srcs/sources_1/bd/$topDesignName/hw_handoff/*.hwh] $overlay_dir/$projName.hwh
file copy -force [glob $projName.srcs/sources_1/bd/$topDesignName/hw_handoff/*.tcl] $overlay_dir/$projName.tcl
