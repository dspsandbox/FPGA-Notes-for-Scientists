...
architecture STRUCTURE of dac_bd is
  ...
  signal clk_250_m120_1 : STD_LOGIC;
  signal clk_250_m150_1 : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of dac_data_1_tdata : signal is "XIL_INTERFACENAME dac_data_1, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
  attribute X_INTERFACE_INFO of dac_data_2_tdata : signal is "xilinx.com:interface:axis:1.0 dac_data_2 TDATA";
  attribute X_INTERFACE_PARAMETER of dac_data_2_tdata : signal is "XIL_INTERFACENAME dac_data_2, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
begin
  clk_125_1 <= clk_125;
  clk_250_m120_1 <= clk_250_m120;
  clk_250_m150_1 <= clk_250_m150;
...
DAC_0: component dac_bd_DAC_0_0
     port map (
      clk => clk_125_1,
      clk_dac_1 => clk_250_m150_1,
      clk_dac_2 => clk_250_m120_1,
      dac_clk_o => DAC_0_dac_clk_o,
