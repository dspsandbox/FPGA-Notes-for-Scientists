...
architecture STRUCTURE of adc_bd is
  ...
  attribute X_INTERFACE_PARAMETER of adc_data_1_tdata : signal is "XIL_INTERFACENAME adc_data_1, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
  attribute X_INTERFACE_INFO of adc_data_2_tdata : signal is "xilinx.com:interface:axis:1.0 adc_data_2 TDATA";
  attribute X_INTERFACE_PARAMETER of adc_data_2_tdata : signal is "XIL_INTERFACENAME adc_data_2, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
begin
